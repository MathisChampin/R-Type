...
Test(CollisionSystem, PlayerHitByShootToPlayer) {
    registry reg;
    System sys;
    ...
    reg.add_component<component::position>(enemy, {20, 20});
    reg.add_component<component::size>(enemy, {5, 5});
    reg.add_component<component::attribute>(enemy, {component::attribute::Player2});
    reg.add_component<component::life>(enemy, {1});
    reg.add_component<component::state>(enemy, {component::state::stateKey::Alive});
    ...
    cr_assert_eq(l.life, 3, "Player's life should be decremented by 3, but is %d", l.life);
    cr_assert_eq(state_shoot._stateKey, 1, "shoot's should be dead = 1, but is %d", state_shoot._stateKey);
}

Test(CollisionSystem, Shoot5Damage) {
    registry reg;
    System sys;
    ...
    cr_assert_eq(l.life, 1, "Player's life should be decremented by 2, but is %d", l.life);
    cr_assert_eq(state_shoot._stateKey, 0, "shoot's should be dead = 0, but is %d", state_shoot._stateKey);
}
...
Test(CollisionSystem, Enemy2HitByShoot) {
    registry reg;
    System sys;
    ...
    cr_assert_eq(s.score, 20, "Player's score should be increased by 20, but is %d", s.score);
    cr_assert_eq(st._stateKey, 0, "Ennemy's should be dead = 0, but is %d", st._stateKey);
    cr_assert_eq(state_shoot._stateKey, 0, "shoot's should be dead = 0, but is %d", state_shoot._stateKey);
}

Test(CollisionSystem, Enemy3HitByShoot) {
    registry reg;
    System sys;
    ...
    cr_assert_eq(s.score, 30, "Player's score should be increased by 30, but is %d", s.score);
    cr_assert_eq(st._stateKey, 0, "Ennemy's should be dead = 0, but is %d", st._stateKey);
    cr_assert_eq(state_shoot._stateKey, 0, "shoot's should be dead = 0, but is %d", state_shoot._stateKey);
}

Test(CollisionSystem, Enemy4HitByShoot) {
    registry reg;
    System sys;
    ...
    reg.add_component<component::position>(enemy, {20, 20});
    reg.add_component<component::size>(enemy, {5, 5});
    reg.add_component<component::attribute>(enemy, {component::attribute::Ennemies4});
    reg.add_component<component::life>(enemy, {1});
    reg.add_component<component::state>(enemy, {component::state::stateKey::Alive});
    ...
    cr_assert_eq(s.score, 40, "Player's score should be increased by 40, but is %d", s.score);
    cr_assert_eq(st._stateKey, 0, "Ennemy's should be dead = 0, but is %d", st._stateKey);
    cr_assert_eq(state_shoot._stateKey, 0, "shoot's should be dead = 0, but is %d", state_shoot._stateKey);
}

Test(CollisionSystem, Enemy5HitByShoot) {
    registry reg;
    System sys;
    ...
    cr_assert_eq(s.score, 50, "Player's score should be increased by 50, but is %d", s.score);
    cr_assert_eq(st._stateKey, 0, "Ennemy's should be dead = 0, but is %d", st._stateKey);
    cr_assert_eq(state_shoot._stateKey, 0, "shoot's should be dead = 0, but is %d", state_shoot._stateKey);
}